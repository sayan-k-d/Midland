              ...
              <div class="st-vertical-middle">
                <div class="st-vertical-middle-in">
                  <div class="st-slider st-style2 st-abt-slider">
                    <div class="st-container" data-autoplay="0" data-loop="1"
                      ...
                      <div class="st-wrapper">
                        ...
                        <div class="slick-slide-in">
                          <div class="st-member st-style1 st-zoom">
                            <div class="st-member-img">
                              <img src="assets/img/story2.webp" alt="story2"
                                class="st-zoom-in">
                        ...
                        <div class="slick-slide-in">
                          <div class="st-member st-style1 st-zoom">
                            <div class="st-member-img">
                              <img src="assets/img/story1.webp" alt="story1"
                                class="st-zoom-in">
                              <!-- <a class="st-doctor-link"
                                href="doctor-profile.html"><i
                                  class="fas fa-link"></i></a>
                        ...
                        <div class="slick-slide-in">
                          <div class="st-member st-style1 st-zoom">
                            <div class="st-member-img">
                              <img src="assets/img/story3.webp" alt="story3"
                                class="st-zoom-in">
                              <!-- <a class="st-doctor-link"
                                href="doctor-profile.html"><i
                                  class="fas fa-link"></i></a>
                        ...
                        <div class="slick-slide-in">
                          <div class="st-member st-style1 st-zoom">
                            <div class="st-member-img">
                              <img src="assets/img/story4.webp" alt="story4"
                                class="st-zoom-in">
                              <!-- <a class="st-doctor-link"
                                href="doctor-profile.html"><i
                                  class="fas fa-link"></i></a>
            ...
            <div class="col-lg-6 wow fadeInRight" data-wow-duration="0.8s"
              ...
              <div class="st-shedule-wrap">
                <div class="st-leader-img">
                  <img src="assets/img/abt_ldr.webp" alt="Leader_img">
                </div>
