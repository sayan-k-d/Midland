...
@section('content')
    ...
    <div class="st-content">
        ...
        <div class="st-hero-wrap st-color1 st-bg st-dynamic-bg overflow-hidden"
            ...
            data-src="{{ $banner->image ?? asset('public/assets/img/hero-bg11.jpg') }}">
            <div class="container">
                <div class="st-hero st-style1 st-type1">
                    <div class="container">
                        <div class="st-hero-text">
                            ...
                            {{-- <div class="st-hero-subtitle">Lorem ipsum dolor sit amet, consectetur mag.<br>Tempor incididunt
                                ut labore et dolore elit.</div> --}}
                        ...
                        <div class="st-vertical-middle">
                            <div class="st-vertical-middle-in">
                                <div class="st-faq-img">
                                    <img src="{{ asset('public/assets/img/faq-img.png') }}" alt="Faq Image">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="st-accordian-wrap">
                            ...
                            <div class="st-accordian">
                                ...
                                <div class="st-accordian-body" style="display: none;">To book
                                    an appointment with Dr B. P. Singh, please <br> call <a href="tel:0522-4042888">
                                        0522-4042888</a>
        ...
        <section class="st-shape-wrap" id="contact">
            <div class="st-shape1"><img src="{{ asset('public/assets/img/shape/contact-shape1.svg') }}" alt="shape1">
            </div>
