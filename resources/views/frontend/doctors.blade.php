                    ...
                    <div class="st-post st-style3 st-zoom st_departments_otr st_doc_otr mt-4">
                        ...
                        <div class="founder_details">
                            <div class="st-post-info">
                                <h2 class="st-post-title blue_text"><a href="{{ route('doctor-profile', ['id' => -1]) }}">
                                ...
                                <div class="card text-center">
                                    <div
                                        ...
                                        <div class="st-post-info ">
                                            ...
                                            <div class="st-post-text">{{ $doctor->biography }}</div>
                                        </div>
                                        <div class="st-post-footer">
                                            <a href="{{ route('doctor-profile', ['id' => $doctor->id]) }}"
                        ...
                        @else
                            <div>
                                <h1 class="no-data text-center">No Services Available <svg
                                        ...
                                        class="bi bi-database-slash" viewBox="0 0 16 16">
                                        <path
