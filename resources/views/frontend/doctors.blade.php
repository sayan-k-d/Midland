                    ...
                    <div class="st-page-heading st-dynamic-bg" data-src="{{ $banner->image }}">
                        <div class="container">
                            <div class="st-page-heading-in text-center">
                                ...
                                <div class="st-page-heading-subtitle mb-4">{{ $banner->description }}</div>
            ...
            <div class="row">
                ...
                <div id="data-container">
                    ...
                    <div class="card-container">
                        @if ($totalDoctors > 0)
                            @foreach ($doctors as $doctor)
                                <div class="card text-center">
                                    <div
                                        class="st-post st-style3 st-zoom st_departments_otr h-100 d-flex flex-column justify-content-between overflow-hidden">
                                        ...
                                        <div class="st-post-info ">
                                            ...
                                            <div class="st-post-text">
                                                {{ \Illuminate\Support\Str::limit($doctor->biography, 150, '...') }}</div>
                                        </div>
                                        <div class="st-post-footer">
                                            <a href="{{ route('doctor-profile', ['id' => $doctor->id]) }}"
                        ...
                        @else
                            <div>
                                <h1 class="no-data text-center">No Services Available <svg
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="currentColor" class="bi bi-database-slash" viewBox="0 0 16 16">
                                        <path
