                ...
                <div class="st-top-header-in">
                    <ul class="st-top-header-list">
                        <li>
                            ...
                            <a href="#">info.midlandhealthcare@gmail.com</a>
                        </li>
                        <li>
                            ...
                            <a href="tel:8004024365"> | 8004024365 | </a>
                            <a href="tel:0522-4042888"> | 0522-4042888 </a>
                        </li>
                    </ul>
                    <a href="appointment.html" class="st-top-header-btn ">Appointment</a>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="st-main-header-in">
                    <div class="st-main-header-left">
                        <a class="st-site-branding" href="index.html"><img src="assets/img/logo.png"
                                alt="Nischinto"></a>
                    </div>
...
@section('content')
    <div class="st-content">
        <div class="st-page-heading st-size-md st-dynamic-bg" data-src="{{ asset('assets/img/hero-bg6.jpg') }}">
            <div class="container">
                <div class="st-page-heading-in text-center">
                    ...
                    <div class="st-page-heading-subtitle mb-4">Our diverse team of
                        experineced and renouned physicians and surgeons share a common
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <span class="blue_text">Professionals </span>
                    ...
                    <div class="st-post st-style3 st-zoom st_departments_otr st_doc_otr mt-4">
                        <div class="founder_img">
                            <a href="/doctor-profile.html" class="st-post-thumb">
                                <img class="st-zoom-in"
                                    src="https://midlandhealthcare.org/wp-content/uploads/2021/06/Dr.-B.P-Singh-1-300x300.png"
                                    alt="blog1">
                            </a>
                        </div>
                        <div class="founder_details">
                            <div class="st-post-info">
                                <h2 class="st-post-title blue_text"><a href="doctor-profile.html">
                                        Dr. B. P. Singh</a></h2>
                                <div class="st-post-meta">
                                    <span class="st-post-date">Department of Respiratory &
                                        Critical Care </span>
                                </div>
                                <div class="st-post-text">With over 30 years of experience,
                                    Dr. Singh is named one of the most inspiring Pulmonologists
                                    in India by The Economic Times. He is also one of the
                                    pioneers in introducing Sleep Medicine in the country.

                                </div>
                            </div>
                            <div class="st-post-footer">
                                <a href="doctor-profile.html" class="st-btn st-style2 st-color1 st-size-medium">Read
                                    More</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="st-iconbox st-style1">
                                ...
                                <div class="st-iconbox-text">Our diverse team of 120+ doctors,
                                    including physicians and clinicians, share a common passion
                                    to
                        ...
                        <div class="col-lg-4">
                            <div class="st-iconbox st-style1">
                                ...
                                <div class="st-iconbox-text">An ISO 9001-2000 certified, NABH
                                    Accredited multi-specialty hospital offering a
                                    patient-centric
                                    care to people of all age group, backed by the NABL
                                    Accredited
                                    Laboratories.
                                </div>
                            </div>
                    ...
                    <div class="card-container">
                        ...
                        <div class="card text-center">
                            <div class="st-post st-style3 st-zoom st_departments_otr">
                                <a href="doctor-profile.html" class="st-post-thumb">
                                    <img class="st-zoom-in" src="{{ asset('assets/img/member1.webp') }}" alt="blog1">
                                </a>
                                <div class="st-post-info ">
                                    <h2 class="st-post-title"><a href="doctor-profile.html">Dr. Apoorva
                                            Singh (Type 1)</a></h2>
                                    <div class="st-post-meta">
                                        <span class="st-post-date">Department of
                                            Respiratory & Critical Care</span>
                                    </div>
                                    <div class="st-post-text">Dr. Apoorva Singh specializes in
                                        Respiratory, Critical Care and Sleep Medicine. Within
                                        these
                                        fields, she possesses extensive knowledge and
                                        experience...</div>
                                </div>
                                <div class="st-post-footer">
                                    <a href="doctor-profile.html" class="st-btn st-style2 st-color1 st-size-medium">View
                                        Profile</a>
                                </div>
                            </div>
                            <div class="st-height-b30 st-height-lg-b30"></div>
                        ...
                        <div class="card text-center">
                            <div class="st-post st-style3 st-zoom st_departments_otr">
                                <a href="doctor-profile-t2.html" class="st-post-thumb">
                                    <img class="st-zoom-in" src="{{ asset('assets/img/member1.webp') }}" alt="blog1">
                                </a>
                                <div class="st-post-info ">
                                    <h2 class="st-post-title"><a href="doctor-profile-t2.html">Dr. Apoorva
                                            Singh (Type 2)</a></h2>
                                    <div class="st-post-meta">
                                        <span class="st-post-date">Department of
                                            Respiratory & Critical Care</span>
                                ...
                                <div class="st-post-footer">
                                    <a href="doctor-profile-t2.html" class="st-btn st-style2 st-color1 st-size-medium">View
                                        Profile</a>
                                </div>
                            </div>
                            <div class="st-height-b30 st-height-lg-b30"></div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="st-footer-widget">
                            ...
                            <ul class="st-footer-widget-nav st-mp0">
                                <li><a href="/departments.html"><i class="fas fa-chevron-right"></i>Gynaecology</a>
                                </li>
