    ...
    <div class="st-content">
        ...
        {{-- <div class="st-page-heading st-size-md st-dynamic-bg" data-src="{{ asset('assets/img/hero-bg6.jpg') }}"> --}}
            <div class="container">
                <div class="st-page-heading-in text-center">
                    <h1 class="st-page-heading-title">Our Departments</h1>
                    <div class="st-page-heading-subtitle">Best Care Right Where You Need
                        It</div>
                </div>
            </div>
        </div><!-- .st-page-heading -->
        ...
        <div class="container">
            <div class="row">
                ...
                @else
                    <div>
                        <h1 class="no-data text-center">No Departments Available <svg xmlns="http://www.w3.org/2000/svg"
