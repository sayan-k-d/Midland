            ...
            <div class="container">
                <div class="st-slider st-style2">
                                                ...
                                                <div class="slick-slide-in" style="width: 100%; display: inline-block;">
                                                    <div class="st-member st-style1 st-zoom">
                                                        <div class="st-member-img">
                                                            <img src="{{ $doctor->image }}" alt="member1"
                                                                class="st-zoom-in">
                                                            <a class="st-doctor-link"
                                                                href="{{ route('doctor-profile', ['id' => $doctor->id]) }}"><i
                    ...
                    <div class="swipe-arrow st-style1">
                        ...
                        <div class="slick-arrow-left slick-arrow slick-hidden" aria-disabled="true" tabindex="-1"><i
                                class="fa fa-chevron-left"></i></div>
                        <div class="slick-arrow-right slick-arrow slick-hidden" aria-disabled="true" tabindex="-1"><i
                ...
                <div class="st-slider st-style2 st-pricing-wrap">
                    <div class="slick-container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
                        ...
                        <div class="slick-wrapper slick-initialized slick-slider">
                            <div class="slick-list draggable">
                                <div class="slick-track"
                                    style="opacity: 1; width: 1149px; transform: translate3d(0px, 0px, 0px);">
                                    <div class="slick-slide slick-current slick-active" data-slick-index="0"
                                        aria-hidden="false" style="width: 383px;">
                                        <div>
                                            <div class="slick-slide-in" style="width: 100%; display: inline-block;">
                                                    ...
                                                    <div class="st-testimonial-info">
                                                        ...
                                                        <div class="st-testimonial-meta">
                                                            <h4 class="st-testimonial-name">Shruti
                                                                Agarwal</h4>
                                                            <div class="st-testimonial-designation">Lucknow</div>
                                                        </div>
                                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="st-post st-style3">
                            ...
                            <div class="st-post-info">
                                <h2 class="st-post-title"><a href="blog-details.html">Midland Healthcare:
                            ...
                            <div class="st-post-footer">
                                <a href="blogs.html" class="st-btn st-style2 st-color1 st-size-medium">Read
                                    More</a>
                            </div>
                        </div>
                        <div class="st-height-b0 st-height-lg-b30"></div>
                    ...
                    <div class="col-lg-4">
                        <div class="st-post st-style3">
                            ...
                            <div class="st-post-info">
                                <h2 class="st-post-title"><a href="blog-details.html">The Role of
                    ...
                    <div class="col-lg-4">
                        <div class="st-post st-style3">
                            ...
                            <div class="st-post-info">
                                <h2 class="st-post-title"><a href="blog-details.html">Important World and
