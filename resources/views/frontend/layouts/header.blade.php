        ...
        <div class="st-top-header">
            <div class="container">
                <div class="st-top-header-in">
                    ...
                    <a href="{{ route('appointment') }}" class="st-top-header-btn ">Appointment</a>
                </div>
            </div>
        </div>
                        ...
                        <div class="st-nav">
                            <ul class="st-nav-list st-onepage-nav">
                                <li><a href="{{ route('index') }}"
                                        class="{{ request()->routeIs('index') ? 'active' : '' }}">Home</a></li>
                                ...
                                <li><a href="{{ route('doctors') }}"
                                        class="{{ request()->routeIs('doctors') ? 'active' : '' }}">Find a Doctor</a>
                                </li>
                                <li><a href="{{ route('blogs') }}"
                                        class="{{ request()->routeIs('blogs') ? 'active' : '' }}">Blog</a></li>
