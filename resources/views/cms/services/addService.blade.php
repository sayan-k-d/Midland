...
<div class="content">
    ...
    <div class="container">
        ...
        <form action="{{ $editFlag ? route('service.update', $service->id) : route('service.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @if($editFlag)
            ...
            <div class="form-group mb-3">
                ...
                @if($editFlag && $service->image_path)
                    <div class="mt-2">
                        <img src="{{ asset('storage/' . $service->image_path) }}" alt="Service Image" width="100">
                    </div>
                @endif
            </div>
