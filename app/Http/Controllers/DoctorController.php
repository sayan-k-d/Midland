...
class DoctorController extends Controller
{
        ...
        try {
            ...
            foreach ($data as $doctor) {
                ...
                if ($doctor->innerImage) {
                    // Detect MIME type dynamically
                    $finfo = finfo_open(FILEINFO_MIME_TYPE);
                    $mimeType = finfo_buffer($finfo, $doctor->innerImage);
                    finfo_close($finfo);

                    // Encode innerImage with the detected MIME type
                    $doctor->innerImage = 'data:' . $mimeType . ';base64,' . base64_encode($doctor->innerImage);
                }
            ...
            //throw $th;
            return redirect()->back()->with(['alertTitle' => 'Failed to Load Doctors', 'error' => $e->getMessage()]);
        }
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $doctor->innerImage = $bannerImagePath;
            ...
            //throw $th;
            return redirect()->back()->with(['alertTitle' => 'Failed to Create Doctor', 'error' => $e->getMessage()]);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            if ($request->hasFile('innerImage')) {
                ...
                $doctor->innerImage = $imageBlob; // Replace 'image_blob' with your actual column name for the image
            }
            ...
            //throw $th;
            return redirect()->back()->with(['alertTitle' => 'Failed to Update Doctor', 'error' => $e->getMessage()]);
        }
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            //throw $th;
            return redirect()->back()->with(['alertTitle' => 'Failed to Delete Doctor', 'error' => $e->getMessage()]);
        }
    }
