...
class FormController extends Controller
{
    public function storeContactDetail(Request $request)
    {
        try {
            ...
            //throw $th;
            return redirect()->back()->with(['alertTitle' => 'Message Delivery Failed', 'error' => 'Your message could not be sent. Please verify your details and try again. If the issue persists, contact support.']);
        }
    }
    public function storeAppointmentDetail(Request $request)
    {
        try {
            ...
            //throw $th;
            return redirect()->back()->with(['alertTitle' => 'Appointment Creation Failed', 'error' => 'There is Some Problem occurred while creating the Appointment. Please check the details and try again or Please contact the administrator.']);
        }
