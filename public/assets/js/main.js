...
/*--------------------------------------------------------------
   21. Slick Slider (About)
 --------------------------------------------------------------*/
function slickAbt() {
  $('.st-abt-slider').each(function () {
    // Slick Variable
    var $ts = $(this).find('.st-container');
    var $slickActive = $(this).find('.st-wrapper');
    var $sliderNumber = $(this).siblings('.slider-number');
...
/*--------------------------------------------------------------
22. Swiper Slider (Home Page Banner)
--------------------------------------------------------------*/

var swiper = new Swiper(".bnrSwiper", {
  slidesPerView: 1,
  spaceBetween: 30,
  loop: true,
